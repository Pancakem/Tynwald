...
/**
 * @brief Returns an existing slot for key, if it already exists, or an empty one
 * 
 * @param ht 
 * @param keys 
 * @param key 
...
/**
 * @brief Returns value, or HT_NOTFOUND if not found
 * 
 * @param ht 
 * @param key 
 * @return void* 
...
/**
 * @brief Inserts if key does not exist, and returns value. Returns current value otherwise;
 * 
 * @param ht 
 * @param key 
 * @param value 
...
/**
 * @brief Removes the key, and returns value before removal. If key does not exist return NOTFOUND
 * 
 * @param ht 
 * @param key 
 * @return void* 
...
/**
 * @brief The following return 1 means operation is successful, 0 otherwise. Note that insert always succeeds
 * 
 * @param set 
 * @param key 
 * @return int 
